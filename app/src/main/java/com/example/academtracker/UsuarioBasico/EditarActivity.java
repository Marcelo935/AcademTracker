...
public class EditarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edicion = (RecyclerView) findViewById(R.id.editarview);
                ...
                db.collection("Acta")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Toast.makeText(EditarActivity.this, "Documento actualizado correctamente", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Toast.makeText(EditarActivity.this, "Error al actualizar el document", Toast.LENGTH_SHORT).show();
                            }
                        });
                        ...
                        .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                            ...
                            public void onSuccess(@androidx.annotation.NonNull QuerySnapshot querySnapshot) {
                                ...
                                for (DocumentSnapshot document : querySnapshot.getDocuments()) {
                                    ...
                                    Intent intent = new Intent(EditarActivity.this, CalificacionesActivity.class);
