...
public class Secretaria_ActAlumnos_adapter extends FirestoreRecyclerAdapter <Alumnos, Secretaria_ActAlumnos_adapter.ViewHolder> {
    AppCompatActivity Activity;
    Context context;

    public Secretaria_ActAlumnos_adapter(@NonNull FirestoreRecyclerOptions<Alumnos> options, AppCompatActivity activity) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull ViewHolder viewHolder, int i, @NonNull Alumnos alumnos) {
        ...
        viewHolder.IrAEditarAlumnos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, EditarAlumno_Secretaria.class);
    ...
    @NonNull
    @Override
    public Secretaria_ActAlumnos_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
