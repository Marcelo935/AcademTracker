...
public class ModificarDirectorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modificar_director);

        regresar = findViewById(R.id.returnbtn);
        guardar = findViewById(R.id.guardardir);
                ...
                db.collection("Acta")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Toast.makeText(ModificarDirectorActivity.this, "Documento actualizado correctamente", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Toast.makeText(ModificarDirectorActivity.this, "Error al actualizar el document", Toast.LENGTH_SHORT).show();
                            }
                        });
        ...
        regresar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ModificarDirectorActivity.this, DirectorActivity.class);
