...
import com.example.academtracker.SignUpActivity;
...
public class AgregarDirectorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregar_director);
      ...
      // String rute_storage_foto = storage_path + "" + datafoto + mAuth.getUid() + "" ;
        ...
        reference.putFile(image_url).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(AgregarDirectorActivity.this," " , Toast.LENGTH_SHORT).show();
                ...
                if(uriTask.isSuccessful())
                {
                    uriTask.addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(AgregarDirectorActivity.this, "Foto Actualizada", Toast.LENGTH_SHORT).show();
                            getData(idd);
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AgregarDirectorActivity.this, "ERROR CARGANDO LA FOTO", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            Toast.makeText(AgregarDirectorActivity.this, "Fallo en registrarse", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
